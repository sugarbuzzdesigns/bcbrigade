    ...
    ?>
            ...
            <form id="zone-editor" method="post" action="">
                ...
                <tr valign="top">
                    ...
                    <td><input type="checkbox" name="zone_enabled" <?php if($zone_fields['zone_enabled'] == 1) echo "checked=checked"; ?> /> <?php _e( 'Enable &#47; Disable the use of this zone', 'be-table-ship'); ?></td>
                    </tr>
                <tr valign="top">
